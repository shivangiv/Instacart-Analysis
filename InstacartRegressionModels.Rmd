...
lm.fit <- lm(formula = order_number~. data= order_products_prior)

lm.fit <- lm(formula =order_number~add_to_cart_order+add_to_cart_order+ order_dow+order_hour_of_day+
             days_since_prior_order , data = order_products_prior) 
